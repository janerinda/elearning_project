...
<!-- ข้อมูลโปรไฟล์ -->
                <div class="col-lg-8">
                    ...
                    <a href="profile_up.php"><button class="bi bi-pencil-square btn btn-warning float-right float-end ">Edit</button><br></a>
                        <div class="row">
                        <div class="col-sm-3">
                        <p class="mb-0">ชื่อ</p>
                        </div>
...
<!-- คะแนน -->    
            <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                        <p class="mb-0">คะแนน</p></div>   
                    <div class="col-sm-9">
                    <p class="text-muted mb-0">1000000 คะแนน</p> </div>
                    </div>
                </div>
                </div>
            </div>
